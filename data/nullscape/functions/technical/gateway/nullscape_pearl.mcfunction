...
execute at @s if block ~-1 ~ ~ end_gateway run kill @s[type=ender_pearl]
execute at @s if block ~1 ~ ~ end_gateway run kill @s[type=ender_pearl]
execute at @s if block ~ ~ ~1 end_gateway run kill @s[type=ender_pearl]
execute at @s if block ~ ~ ~-1 end_gateway run kill @s[type=ender_pearl]
execute at @s if block ~ ~-1 ~ end_gateway run kill @s[type=ender_pearl]
execute at @s if block ~ ~1 ~ end_gateway run kill @s[type=ender_pearl]
execute at @s if block ~1 ~ ~1 end_gateway run kill @s[type=ender_pearl]
execute at @s if block ~1 ~ ~-1 end_gateway run kill @s[type=ender_pearl]
execute at @s if block ~-1 ~ ~-1 end_gateway run kill @s[type=ender_pearl]
execute at @s if block ~-2 ~ ~ end_gateway run kill @s[type=ender_pearl]
execute at @s if block ~2 ~ ~ end_gateway run kill @s[type=ender_pearl]
execute at @s if block ~ ~ ~2 end_gateway run kill @s[type=ender_pearl]
execute at @s if block ~ ~ ~-2 end_gateway run kill @s[type=ender_pearl]