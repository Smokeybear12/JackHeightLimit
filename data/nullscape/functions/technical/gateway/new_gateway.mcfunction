...
execute positioned ~ 52 ~ align xyz unless entity @e[type=marker,distance=..20,tag=ns.nullscape_gateway,tag=global.ignore] run summon marker ~0.5 52 ~0.5 {Tags:['ns.nullscape_gateway','global.ignore'],CustomName:'"Nullscape Gateway"'}
